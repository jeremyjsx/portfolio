...
A small, predictable publishing surface that other apps—like this portfolio—can consume without re-implementing content storage.

## Why it matters here

This site’s writing section reads published posts from Entries. Upload markdown, publish, and the portfolio picks it up on the next revalidation cycle.
`,
